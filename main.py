...
class ProxyList:
    ...
    def test_proxy_list(self, proxy: str) -> None:  # Necessita de um argumento, para receber apenas 1 proxy, pois servirá de iterador no executor.map().
    ...
    def fetch_proxy_list(self): # Aqui uso o ThreadPoolExecutor
        ...
        while True:
            ...
            with ThreadPoolExecutor(max_workers=30) as executor:
                executor.map(self.test_proxy_list, self.proxies_list)  # Aqui ele recebe nosso método, e utiilza o 2º param, para pegar cada item e jogar no 1º param.
